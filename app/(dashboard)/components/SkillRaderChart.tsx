...
const data = [
  ...
  { subject: "ML MODELING", current: 70, goal: 85 },
  { subject: "ENGINEERING", current: 50, goal: 80 },
  { subject: "STRATEGY", current: 45, goal: 75 },
  ...
  <div className="w-full mx-auto mb-10 mt-15 bg-white rounded-xl p-8">
    ...
    <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-[#E0E3E5] border-t text-center">
      ...
      <div>
        ...
        <p className="font-semibold text-[12px] text-[#43474F]">Engineering</p>
      </div>
